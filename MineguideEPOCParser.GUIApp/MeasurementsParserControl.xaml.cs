...
{
    /// <summary>
    /// Lógica de interacción para MeasurementsParserControl.xaml
    /// </summary>
    public partial class MeasurementsParserControl : UserControl, IDisposable, IAsyncDisposable
    {
        // Dependency property IsParsing
        public static readonly DependencyProperty IsParsingProperty = DependencyProperty.Register(
            nameof(IsParsing),
            typeof(bool),
            typeof(MeasurementsParserControl),
        ...
        public MeasurementsParserControl()
        {
            InitializeComponent();
