...
namespace MineguideEPOCParser.GUIApp
{
	...
	public partial class FileEncodingConverterControl : UserControl
    {
        ...
        private async void ParseButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            // Get the encoding from the combo box
            string encodingName = FileEncodingComboBox.Text;
            ...
            try
            {
                try
                {
                    await FileEncodingConverter.ConvertToUTF8(encodingName, inputFile, outputFile, CancellationTokenSource.Token);
            ...
            {
                MessageBox.Show($"An error occurred while converting the file:\n\n{ex.Message}", "Error", MessageBoxButton.OK, MessageBoxImage.Error);
            }
            finally
            {
                // Reset the flag
        ...
        {
            InputFileTextBox.Text = BrowseFile<Microsoft.Win32.OpenFileDialog>(string.Empty, InputFileTextBox.Text) ?? string.Empty;
        }
